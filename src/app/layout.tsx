...
export const metadata: Metadata = {
  ...
  keywords: "CV builder, resume maker, job application, professional CV, resume templates, career tools",
  authors: [{ name: "MakerCV Team" }],
  openGraph: {
    title: "MakerCV - Create CVs That Actually Get You Hired",
    description: "Build stunning, customized CVs in minutes with creative freedom.",
    type: "website",
